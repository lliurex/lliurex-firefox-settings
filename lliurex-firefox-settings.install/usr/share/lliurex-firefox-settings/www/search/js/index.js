...
function drawLinks(links){
    for (i in links){
        //lliurex:{url:"http://www.lliurex.net",img:"corro_ratones.png", desc:"web de LliureX"},
        var ahref=$(document.createElement("a")).attr("href", links[i].url);
        var divcontainer=$(document.createElement("div")).addClass("linkIcon").css("background-image", "url(css/icons/"+links[i].img+")").attr("title", links[i].desc).attr("data-toggle","tooltip").attr("data-placement","bottom").addClass("customTooltip");
        $(ahref).append(divcontainer);

        $("#linksContainer").append(ahref);
